...
public class BoardForQueensPuzzle {
    ...
    public boolean lastIsNg() {
        if (lastRankFilled == 0) return false;
            ...
            if(filesWithQueens[lastRankFilled] == filesWithQueens[lastRankFilled - 1]) return true;
            else if (filesWithQueens[lastRankFilled] == filesWithQueens[lastRankFilled - 1]  + 1 ||
                     filesWithQueens[lastRankFilled] == filesWithQueens[lastRankFilled - 1]  - 1 ) return true;
            return false;
    ...
    public void populate( int file) {
        ...
        System.out.println(filesWithQueens[lastRankFilled + 1]);
    }
